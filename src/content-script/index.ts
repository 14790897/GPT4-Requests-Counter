...
const callback = async function (mutationsList, observer) {
  ...
  try {
    ...
    if (mutation.type === 'characterData') {
      ...
      // // 检查每张图片的 alt 属性
      // images.forEach((img) => {
      //   if (img.alt === 'Generated by DALL·E') {
      //     console.log('找到了一张图片，其 alt 属性为 "Generated by DALL·E"')
      //     intoCount = true
      //   }
      // })
      // console.log('intoCount:', intoCount)
      if (parentNode) {
        let increment
...
async function updateTimerCountData() {
  // 获取计数和时间列表
